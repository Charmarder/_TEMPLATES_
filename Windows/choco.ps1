...
cinst curl -y                           # cURL 7.67.0 (1,333,002)
cinst ctags --alow-empty-checksums -y   # it is needed for Vim taglist.vim plugin

cinst strawberryperl -y             # Strawberry Perl 5.30.1.1 (756,344)
cinst python3 -y                    # Python 3.x 3.8.0 (1,315,202)
cinst nodejs.install -y             # Node JS (Install) 13.2.0 (3,076,632)
cinst yarn -y                       # Yarn (Install) 1.19.2
